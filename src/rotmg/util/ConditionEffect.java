...
public class ConditionEffect {
	...
	public static Vector<ConditionEffect> effects = new Vector<>(
			...
			new ConditionEffect("Hallucinating", HALLUCINATING_BIT, new int[] { 42 },
					TextKey.CONDITIONEFFECT_HALLUCINATING),
			...
			new ConditionEffect("Armor Broken Immune", ARMORBROKEN_IMMUNE_BIT, null,
					TextKey.CONDITIONEFFECT_ARMOR_BROKEN_IMMUNE),
			...
			new ConditionEffect("Invulnerable", INVULNERABLE_BIT, new int[] { 17 },
					TextKey.CONDITIONEFFECT_INVULNERABLE),
			new ConditionEffect("Armored", ARMORED_BIT, new int[] { 16 }, TextKey.CONDITIONEFFECT_ARMORED),
			new ConditionEffect("Armor Broken", ARMORBROKEN_BIT, new int[] { 55 },
					TextKey.CONDITIONEFFECT_ARMOR_BROKEN),
			new ConditionEffect("Hexed", HEXED_BIT, new int[] { 42 }, TextKey.CONDITIONEFFECT_HEXED),
			new ConditionEffect("Ninja Speedy", NINJA_SPEEDY_BIT, new int[] { 0 },
					TextKey.CONDITIONEFFECT_NINJA_SPEEDY),
			...
			new ConditionEffect("Paralyzed Immune", PARALYZED_IMMUNE_BIT, null,
					TextKey.CONDITIONEFFECT_PARALYZEDIMMUNE),
			...
			new ConditionEffect("Pet Disable", PET_EFFECT_ICON_BIT, new int[] { 27 }, TextKey.CONDITIONEFFECT_STASIS,
					true),
	...
	public String toString() {
		return "ConditionEffect{" + "name='" + name + '\'' + ", bit=" + bit + ", iconOffsets="
				+ Arrays.toString(iconOffsets) + ", localizationKey='" + localizationKey + '\'' + ", icon16Bit="
				+ icon16Bit + '}';
	}
